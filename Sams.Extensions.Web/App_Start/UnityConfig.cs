...
namespace Sams.Extensions
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(this IUnityContainer container)
        {
            ...
            container.RegisterType<IEmployeeRoster, EmployeeRosterData>();
            container.RegisterType<IEmployeeRosterBusiness, EmployeeRosterBusiness>();
            container.RegisterType<IGroupLReportBusiness, GroupLReportBusiness>();
            container.RegisterType<IGroupLReportData, GroupLReportData>();
